...
public class RateCalculatorTest {
    ...
    public void getRate() throws Exception {
        ...
        int loanAmount = 1000;
        RateCalculator rateCalculator = new RateCalculator(loanAmount,lenderProposalList);
        double result = rateCalculator.getRate(1000);
        assertThat(result, closeTo(0.07, 0.01));
        assertNotEquals(result,0.07,0.001);
    ...
    public void getTotalMarketAmount() throws Exception {
        ...
        RateCalculator rateCalculator = new RateCalculator(requestedAmount,lenderProposalList);

        int result = rateCalculator.getTotalMarketAmount();
        System.out.println(result);
        assertThat(result, is(2330));
    }
